...
@router.callback_query(F.data.regexp(r"\d{1,2}_00000"))
...
@router2.callback_query(F.data.regexp(r"[01]_00001"))
...
@router2.callback_query(F.data.regexp(r"\d_00002"))
async def date_poll(call, dispatcher):
    ...
    await call.message.answer(text, reply_markup=subject_poll_keyboard)
